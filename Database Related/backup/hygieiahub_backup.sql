...
INSERT INTO `additional_service` VALUES (2,'sweep','','RM 70.00','1.00 hour'),(3,'Mop','','RM 80.00','1.00 hour'),(4,'Window Cleaning','Includes interior & exterior (up to 2nd floor)','RM 100.00','1.50 hour'),(6,'wiping','','RM 70.00','1.00 hour');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`shira`@`%`*/ /*!50003 TRIGGER before_insert_service
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`shira`@`%`*/ /*!50003 TRIGGER after_insert_service
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`shira`@`%`*/ /*!50003 TRIGGER after_update_service
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`shira`@`%`*/ /*!50003 TRIGGER after_delete_service
...
CREATE TABLE `additional_service_log` (
  ...
  `old_duration` varchar(11) DEFAULT NULL,
  `new_duration` varchar(11) DEFAULT NULL,
  PRIMARY KEY (`log_id`)
...
INSERT INTO `additional_service_log` VALUES (1,1,'INSERT','2025-05-07 22:55:52','Admin Atilia','gffggf',NULL,'',NULL,'100.00',NULL,'1.00'),(2,1,'UPDATE','2025-05-09 03:11:06','Admin Atilia','1','','','100.00','RM 70.00','1.00','1.00 hour'),(3,1,'DELETE','2025-05-09 03:50:35','Admin Atilia','1','',NULL,'RM 70.00',NULL,'1.00 hour',NULL),(4,2,'INSERT','2025-05-09 03:51:02','Admin Atilia','sweep',NULL,'',NULL,'RM 70.00',NULL,'1.00 hour'),(5,3,'INSERT','2025-05-14 15:53:56','Admin Atilia','Mop',NULL,'',NULL,'RM 75.00',NULL,'1.00 hour'),(6,4,'INSERT','2025-05-14 15:54:46','Admin Atilia','Window Cleaning',NULL,'Includes interior & exterior (up to 2nd floor)',NULL,'RM 100.00',NULL,'1.50 hour'),(7,5,'INSERT','2025-05-14 16:00:13','Admin Atilia','Dusting',NULL,'',NULL,'RM 60.00',NULL,'1.00 hour'),(8,6,'INSERT','2025-05-15 08:06:53','Admin Atilia','wiping',NULL,'',NULL,'RM 70.00',NULL,'1.00 hour'),(9,3,'UPDATE','2025-05-15 08:08:12','Admin Atilia','Mop','','','RM 75.00','RM 80.00','1.00 hour','1.00 hour'),(10,5,'DELETE','2025-05-15 08:10:54','Admin Atilia','Dusting','',NULL,'RM 60.00',NULL,'1.00 hour',NULL),(11,3,'UPDATE','2025-05-16 15:34:51','Admin Atilia','Mop','','','RM 80.00','RM 80.00','1.00 hour','1.00 hour'),(12,4,'UPDATE','2025-05-16 15:45:53','Admin Atilia','Window Cleaning','Includes interior & exterior (up to 2nd floor)','Includes interior & exterior (up to 2nd floor)','RM 100.00','RM 100.00','1.50 hour','1.50 hour'),(13,3,'UPDATE','2025-05-16 16:01:27','Admin Atilia','Mop','','','RM 80.00','RM 80.00','1.00 hour','1.00 hour');
...
CREATE TABLE `booking` (
  ...
  `size_of_kitchen` varchar(15) NOT NULL,
...
INSERT INTO `customer` VALUES (1,'Peter Parker','peter@gmail.com','$2y$10$512yAvTwuWtodfujAfHNeuOA2SDiPVy5X8xGilP9Qt/RxANqfn2Ba','0173647364','99, Taman Desa Duranta, negeri sembilan, seremban','2025-05-07 02:03:15');
...
-- Dump completed on 2025-05-19 23:27:29
