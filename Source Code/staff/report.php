                            ...
                            <div class="card card-transparent">
                                <div class="card-body">
                                    <form class="form-inline" method="POST">
                                        ...
                                        <?php else: ?>
                                            <input type="number" class="form-control form-control-sm mr-3" name="selected_date" id="selected_date" min="2000" max="2099" value="<?php echo htmlspecialchars($selected_date); ?>">
                                        <?php endif; ?>
