...
<body>
                                                    ...
                                                    while ($row = $result->fetch_assoc()) {
                                                        echo "<tr>
                                                            ...
                                                            <td style='text-align: center;'>
                                                                <button class='btn btn-dark btn-sm' onclick=\"openModal('edit', '" . htmlspecialchars($row['id']) . "', '" . htmlspecialchars($row['name']) . "', '" . htmlspecialchars($row['email']) . "', '" . htmlspecialchars($row['phone_number']) . "', '" . htmlspecialchars($row['branch']) . "', '" . htmlspecialchars($row['role']) . "')\">Edit</button>
                                                            </td>
                                                        </tr>";
                                                    }
                                                } else {
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <form class="pt-3" id="staffForm" method="POST" action="dbconnection/dbmanagestaff.php">
    ...
    <script>
        ...
        function changeInputColor() {
            ...
            if (selectRole.value !== '') {
                selectRole.style.color = '#495057';
            } else {
                selectRole.style.color = '';
            }

            if (selectBranch.value !== '') {
                selectBranch.style.color = '#495057';
            } else {
                selectBranch.style.color = '';
            }

            if (selectStatus.value !== '') {
                selectStatus.style.color = '#495057';
            } else {
                selectStatus.style.color = '';
            }
        }

        function openModal(action, id = '', name = '', email = '', phone = '', branch = '', role = '') {
